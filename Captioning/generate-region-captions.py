...
# -----------------------------
def parse_args():
    parser = argparse.ArgumentParser(description="Generate region-based dense captions using Florence-2 model")
    parser.add_argument('--dataset_path', type=str, required=True, help='Path to CRIC JSON file')
    parser.add_argument('--image_dir', type=str, required=True, help='Directory containing images')
    parser.add_argument('--output', type=str, default='denseRegionCaptions.txt', help='Path to save output')
...
def main():
    ...
    print(f"✅ Region-based captions written to {args.output}")
